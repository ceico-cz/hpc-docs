...
Optional tweaks to make working on our clusters more comfortable.

* [Bash tweaks](bash-tweaks.md) - a coloured prompt, better history and Slurm shorthands
* [Tabbed screen sessions](screen.md) - a status line with tabs, hostname and time in GNU screen
